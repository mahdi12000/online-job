...
?> 
       	 <div class="col-lg-12">
            <h1 class="page-header">Liste des utilisateurs  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Ajouter utilisateur</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 --> 
   		 	<div class="col-lg-12"> 
