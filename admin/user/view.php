...
<div class="panel-body inf-content">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1><strong>Profil de l'utilisateur</strong></h1><br>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          <option value="Administrator"  <?php echo ($singleuser->ROLE=='Administrator') ? 'selected="true"': '' ; ?>>Administrateur</option>
                          <option value="Staff" <?php echo ($singleuser->ROLE=='Staff') ? 'selected="true"': '' ; ?>>Personnel</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
             ...
             <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <button class="btn btn-primary " name="save" type="submit" ><span class="fa fa-save fw-fa"></span> Télécharger</button>
              ...
              <div class="modal-content">
                ...
                <form action="controller.php?action=photos" enctype="multipart/form-data" method="post">
                  ...
                  <div class="modal-footer">
                    <button class="btn btn-default" data-dismiss="modal">Fermer</button> <button class="btn btn-primary"
                    name="savephoto" type="submit">télèchager photo</button>
                  </div>
                </form>
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
