...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Job Online</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Job Online</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
                            ...
                            <div class="modal-content">
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        name="savephoto" type="submit"> Photo</button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content-->
                        </div><!-- /.modal-dialog -->
  ...
  <aside style="background-color:		#4169E1"class="main-sidebar">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">fstscode</a>.</strong> All rights
    reserved.
  </footer>
