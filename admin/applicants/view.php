...
<div 	style="background-color:#4169E1" class="col-sm-12 content-footer">
<p style="color:white"><i class="fa fa-paperclip"></i>  Attachment Files</p>
	<div class="col-sm-12 slider">
		 <h3 style="color:white">Download Resume <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div> 
