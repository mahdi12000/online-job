...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">listes des offres  <a href="index.php?view=add" class="btn btn-warning ">  <i class="fa fa-plus-circle"></i> Ajouter offre</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
