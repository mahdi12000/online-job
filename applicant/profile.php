    ...
    <div class="row">
        ...
        <div class="col-sm-3"><!--left col-->
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong>Nom complet</strong></span> 
          ...
          <div class="box box-solid">  
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked"> 
                <li class="<?php echo ($view=='appliedjobs' || $view=='') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=appliedjobs'; ?>"><i class="fa fa-list"></i> Postes postulés
                   </a></li>
                  <li class="<?php echo ($view=='accounts') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=accounts'; ?>"><i class="fa fa-user"></i>Comptes </a></li>
                            ...
                            <div class="modal-content">
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        "button">Fermer</button> <button  class="btn btn-primary"
                                        name="savephoto" type="submit">Telecharger photo</button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
